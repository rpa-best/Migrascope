...
import { ProgressBar } from 'app/(Main)/components/Main/components/ProgressBars/ProgressBar';

import { ProgressBarsProps } from 'app/(Main)/components/Main/components/ProgressBars/types';
